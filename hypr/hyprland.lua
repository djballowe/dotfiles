...
local menu = "rofi -show drun -p -theme ~/.config/rofi/drun.rasi"
...
hl.window_rule({ match = { class = "^(librewolf)$" }, workspace = "2 silent" })
hl.window_rule({ match = { class = "^(firefox)$" }, workspace = "3 silent" })
hl.window_rule({ match = { class = "^(brave-browser)$" }, workspace = "4 silent" })
hl.window_rule({ match = { class = "^(steam)$" }, workspace = "5 silent" })

-- See https://wiki.hypr.land/Configuring/Basics/Autostart/
hl.on("hyprland.start", function()
    -- Autostart workspace applications.
    hl.exec_cmd(terminal)
    hl.exec_cmd("mullvad-exclude librewolf")
    hl.exec_cmd("mullvad-exclude firefox")
    hl.exec_cmd("mullvad-exclude brave")
    hl.exec_cmd("steam")

    -- Autostart session services and applets.
    hl.exec_cmd("hyprpaper")
    hl.exec_cmd("hypridle")
    hl.exec_cmd("dex --autostart --environment generic")
...
-- Screenshots.
hl.bind("Home", hl.dsp.exec_cmd([[grim -g "$(slurp)" ~/pictures/screenshots/$(date +%Y-%m-%d_%H-%M-%S).png]]))
hl.bind(mainMod .. " + Home", hl.dsp.exec_cmd([[grim ~/pictures/screenshots/$(date +%Y-%m-%d_%H-%M-%S).png]]))
...
for workspace = 1, 10 do
    local key = workspace % 10 -- Workspace 10 maps to key 0.
